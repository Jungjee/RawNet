...
#from model_rwcnn_cLoss import get_model
from model_rwcnn_cLoss_bsLoss import get_model
#from model_rwcnn_fullpre_cLoss_bsLoss import get_model
...
#print('Dim embedding layer', model.layers[-3].name)
#exit()
...
f_eer = open(save_dir + 'eers.txt', 'w', buffering=1)
